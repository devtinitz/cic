                        ...
                        <div class="account-box is-form">
                            <div class="form-head">
                                <div class="form-head-inner">
                                    <div class="left">
                                        <h3>{{$section_title}}</h3>
                                        <p><i class="lnil lnil-warning"></i> Cette section est réservée pour la modification d'une agence.</p>
                                    </div>
                                    <div class="right">
                                        <div class="buttons">
                                ...
                                <form action="{{route('agences.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="text" class="input" name="libelle" placeholder="" value="{{old('libelle', $agence->libelle)}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-6">
                                                ...
                                                <div class="control">
                                                    <select class=" form-control p-2 select-agent" name="siege" style="width:100%; heigth:38px !important; border: 1px solid #ccc !important;">
                                                        ...
                                                        @foreach($sieges as $siege)
                                                            <option value="{{$siege->id}}" {{old('siege', $agence->siege_id) == $siege->id ? 'selected' : ''}}>{{ ucfirst($siege->libelle) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <select class=" form-control p-2 select-agent" name="country" style="width:100%; heigth:38px !important; border: 1px solid #ccc !important;">
                                                        ...
                                                        @foreach($countries as $country)
                                                            <option value="{{$country->id}}"
                                                                    {{old('country', $agence->country_id) == $country->id ? 'selected' : ''}}
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="phone" class="input" name="contact" placeholder="" value="{{old('contact', $agence->contact ?? '')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="text" class="input" name="adresse" placeholder="" value="{{old('adresse', $agence->adresse ?? '')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="text" class="input" name="localisation" placeholder="" value="{{old('localisation', $agence->localisation ?? '')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
