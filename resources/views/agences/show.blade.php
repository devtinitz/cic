                            ...
                            <div class="column is-12">
                                <div class="demo-card">
                                    <div class="demo-title">
                                        <h3 class="title is-thin is-5">{{ ucfirst($agence->libelle) }}</h3>
                                    </div>
                                    <div class="card-inner">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label>Total département : </label> {{$departements->count()}}
                                            </div>
                                            <div class="col-md-4">
                                                <label>Total employés : </label> {{ $agence->allEmployes->count() }}
                                            </div>
                                            <div class="col-md-4">
                                                <label>Horaires de pointage : </label> {{ $horaires->count() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 form-group mb-3">
                                                        <input type="time" readonly class="form-control jour1 debut1" value="{{ $horaire->debut }}" name="debut[]"  >
                                                    </div>

                                                    <div class="col-md-5 form-group mb-3">
                                                        <input type="time" readonly class="form-control jour1 fin1" value="{{ $horaire->fin }}" name="fin[]" >
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="demo-card">
                                    <div class="demo-title">
                                        <h3 class="title is-thin is-5">Liste des départements ( {{ $departements->count() }} ) </h3>
                                    </div>
                                    <div class="card-inner">
