    ...
    <div class="page-content-inner">
        ...
        <!--Edit Profile-->
            <div class="account-wrapper">
                        ...
                        <div class="account-box is-form">
                            <div class="form-head">
                                <div class="form-head-inner">
                                    <div class="left">
                                        <h3>{{$section_title}}</h3>
                                        <p><i class="lnil lnil-warning"></i> Cette section est réservée pour afficher la liste des employés.</p>
                                    </div>
                                    <div class="right">
                                        <div class="buttons">
                            ...
                            <div class="form-body">
                                <div class="s-card demo-table column.is-half">
                                    <div class="form-fieldset p-0 mb-3 row">
                                        <div class="col-md-12">
                                            <span style="font-size: 14px; font-weight: 600">Total : {{ $employes->total() }}</span>
                                            <div class="buttons mt-4">

                                                <a class="button h-button is-elevated text-white h-modal-trigger" data-modal="searchEmploye" style="background-color: {{$setting->companycolor}} !important;" href="#">
                                                  <span class="icon">
                                                      <i class="lnil lnil-users"></i>
                                                  </span>
                                                    <span>Rechercher un employé</span>
                                                </a>
                                                <a class="button h-button is-elevated text-white h-modal-trigger" data-modal="importEmploye" style="background-color: #868793 !important;" href="#">
                                                  <span class="icon">
                                                      <i class="lnil lnil-download"></i>
                                                  </span>
                                                    <span>Importer (Format excel)</span>
                                                </a>
                ...
                @include('employes.search')
                @include('employes.import')
                @endsection
