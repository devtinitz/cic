                        ...
                        <div class="account-box is-form">
                            <div class="form-head">
                                <div class="form-head-inner">
                                    <div class="left">
                                        <h3>{{$section_title}}</h3>
                                        <p><i class="lnil lnil-warning"></i> Cette section est réservée pour afficher la liste des horaires.</p>
                                    </div>
                                    <div class="right">
                                        <div class="buttons">
                                            @include('horaires.precedent')
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-body">
                                ...
                                @include('paginations.default', ['paginator' => $departements ])
                            </div>
                        </div>
                    </div>
                    <!--Navigation-->
