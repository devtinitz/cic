                        ...
                        <div class="account-box is-form">
                            <div class="form-head">
                                <div class="form-head-inner">
                                    <div class="left">
                                        <h3>{{$section_title}}</h3>
                                        <p><i class="lnil lnil-warning"></i> Cette section est réservée pour la modification d'un service.</p>
                                    </div>
                                    <div class="right">
                                        <div class="buttons">
                                ...
                                <form action="{{route('services.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-8">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="text" id="identifiant" class="input" name="libelle" placeholder="Libéllé" value="{{old('libelle', $service->libelle)}}">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="control">
                                                    <select class=" form-control p-2 select-agent" name="departement" style="width:100%; heigth:38px !important; border: 1px solid #ccc !important;">
                                                        ...
                                                        @foreach($departements as $departement)
                                                            <option value="{{$departement->id}}" {{old('siege', $service->departement_id) == $departement->id ? 'selected' : ''}}>{{ ucfirst($departement->libelle) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <select class=" form-control p-2" name="status" style="width:100%; heigth:38px !important; border: 1px solid #ccc !important;">
                                                        <option value="1" {{old('status', $service->status) == "1" ? 'selected' : ''}}>Actif</option>
                                                        <option value="0" {{old('status', $service->status) == "0" ? 'selected' : ''}}>Inactif</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
