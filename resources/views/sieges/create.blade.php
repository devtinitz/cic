                        ...
                        <div class="account-box is-form">
                            <div class="form-head">
                                <div class="form-head-inner">
                                    <div class="left">
                                        <h3>{{$section_title}}</h3>
                                        <p><i class="lnil lnil-warning"></i> Cette section est réservée pour la creation d'un siège.</p>
                                    </div>
                                    <div class="right">
                                        <div class="buttons">
                            ...
                            <div class="form-body">
                                <form action="{{route('sieges.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-6">
                                            ...
                                            <div class="field">
                                                <div class="control">
                                                    <input type="text" class="input" name="horaire" placeholder="" value="{{old('horaire')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-6">
